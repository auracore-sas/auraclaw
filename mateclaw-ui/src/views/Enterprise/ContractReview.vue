...
const cases: Case[] = [
  {
    id: 'msa-acme-2026q2',
    title: 'Acme Corp - Renovación MSA',
    counterparty: 'Acme Corp (comprador)',
    version: 'v3.2 · 2026-Q2',
    value: 'Valor del contrato: US$12M / 3 años',
    line: 'Línea de negocio: SaaS empresarial',
    risk: 'high',
    status: 'ai_reviewed',
    clauses: [
      {
        id: 'c1',
        type: 'Cláusula de indemnización',
        risk: 'high',
        location: 'Cláusula 8.2 · pág. 14',
        quote: 'La parte B indemnizará a la parte A por todas las pérdidas directas e indirectas derivadas de este acuerdo, incluidas, entre otras, pérdidas de beneficios, pérdida de prestigio y daños punitivos, sin límite',
        deviation: 'Nuestro Legal Playbook exige un tope de indemnización no mayor a 12 meses de servicios y excluye expresamente daños punitivos e indirectos',
        suggestion: 'Cambio propuesto: la responsabilidad total de la parte B hacia la parte A no excederá el total de servicios pagados en los últimos 12 meses del acuerdo; ninguna parte será responsable por pérdidas indirectas, de beneficios o daños punitivos de la otra.',
        playbookQuote: 'Toda cláusula de indemnización de contratos comerciales debe incluir un tope de responsabilidad (máx. 12 meses de servicios) y exclusión de daños indirectos',
        playbookRef: 'Legal Playbook v3.1 · sección 4.2',
        precedents: [
          { contract: 'Zerto MSA 2025', outcome: 'Tope escalonado adoptado (primeros 12 meses = 100% de servicios, después = 50%)' },
          { contract: 'BlueWave SLA 2024', outcome: 'El cliente aceptó tope de 12 meses de servicios + exclusión de daños punitivos' },
        ],
        confidence: 'Alta (4 evidencias)',
      ...
      },
      {
        ...
        risk: 'medium',
        location: 'Cláusula 11.4 · pág. 19',
        quote: 'Ante cualquier filtración de datos, la parte B notificará a la parte A por escrito en un plazo de 4 horas',
        deviation: 'Nuestro Playbook exige un plazo de notificación de 72 horas; 4 horas es poco realista y propenso a falsas alarmas',
        suggestion: 'Se sugiere cambiarlo a 72 horas (alineado con GDPR) y ampliar «por escrito» a «cualquier medio trazable (incluidos correo y canales controlados de Slack)»',
        playbookQuote: 'Plazo de notificación de filtración = 72 horas, alineado con el Art. 33 del GDPR',
        playbookRef: 'Legal Playbook v3.1 · sección 5.1',
        precedents: [
          { contract: 'EuroSoft DPA 2025', outcome: 'El cliente aceptó el plazo de notificación de 72 horas' },
        ],
        confidence: 'Media (2 evidencias)',
        model: 'Claude Sonnet 4.6',
      },
      {
        id: 'c3',
        ...
        risk: 'low',
        location: 'Cláusula 2.3 · pág. 3',
        quote: 'Este acuerdo se renovará automáticamente por un año salvo que cualquiera de las partes notifique por escrito 30 días antes del vencimiento',
        deviation: 'Nuestro Playbook recomienda un plazo de notificación de 60 días para alinearlo con el proceso de aprobación presupuestaria',
        suggestion: 'Modificar el plazo de notificación a 60 días',
        playbookQuote: 'El plazo de notificación para salir de la renovación automática ≥ 60 días',
        playbookRef: 'Legal Playbook v3.1 · sección 3.4',
        precedents: [],
        confidence: 'Alta (desviación clara del playbook)',
        model: 'Claude Sonnet 4.6',
      },
    ],
    chain: [
      { who: 'Revisor Legal IA', note: 'Revisión cláusula por cláusula completada (3 desviaciones)', at: 'Hoy 09:42', done: true },
      { who: 'L. Fernández (Legal)', note: 'En revisión', at: 'Hoy 10:15', done: false },
      { who: 'Dra. Zhang, Directora Legal', note: 'Pendiente de aprobación', at: null, done: false },
      { who: 'G. Wang, Director de BD', note: 'Pendiente de firma', at: null, done: false },
    ],
  },
  {
    id: 'nda-vendora',
    title: 'Vendor A NDA',
    counterparty: 'Vendor A Inc. (proveedor)',
    version: 'v1.0 · 2026-04',
    value: 'Período de confidencialidad: permanente',
    line: 'Línea de negocio: compras',
    risk: 'high',
    status: 'pending_legal',
    clauses: [
      {
        id: 'c1',
        type: 'No competencia no estándar',
        risk: 'high',
        location: 'Cláusula 5.1 · pág. 4',
        quote: 'El firmante no mantendrá relaciones laborales o de consultoría durante 5 años con ninguna empresa cuyo negocio se solape con el de la contraparte',
        deviation: 'Nuestro Playbook no permite cláusulas de no competencia en NDA, y menos con un plazo tan largo de 5 años',
        suggestion: 'Se sugiere eliminar por completo la cláusula 5.1; las obligaciones de no competencia requieren un acuerdo independiente',
        playbookQuote: 'Los NDA no deben incluir cláusulas de no competencia; estas requieren un acuerdo independiente',
        playbookRef: 'Legal Playbook v3.1 · sección 6.2',
        precedents: [],
        confidence: 'Alta',
        model: 'Claude Sonnet 4.6',
      },
    ...
    chain: [
      { who: 'Revisor Legal IA', note: 'Revisión completada (1 riesgo alto)', at: 'Hoy 08:30', done: true },
      { who: 'M. Wong (Legal)', note: 'Inició comunicación de reescritura', at: 'Hoy 09:15', done: false },
      { who: 'Dra. Zhang, Directora Legal', note: 'Pendiente de aprobación', at: null, done: false },
    ],
  },
  {
    id: 'q2-vendor-cmp',
    title: 'Q2 comparativa de cláusulas de proveedores',
    counterparty: 'Resumen de 5 proveedores',
    version: 'Informe comparativo v1',
    value: 'Valor total de contratos: US$45M',
    line: 'Línea de negocio: compras',
    risk: 'medium',
    status: 'ai_reviewed',
    clauses: [],
    chain: [
      { who: 'Comparador de Contratos IA', note: 'Informe comparativo generado', at: 'Ayer 16:00', done: true },
      { who: 'Director de Compras', note: 'En revisión', at: null, done: false },
    ],
  },
]
