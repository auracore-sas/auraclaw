 ...
 * Files are deliberately NOT listed here any more: this rail is about the
 * CURRENT run (plan + sub-agent tree), while the artifacts of the whole
 * conversation live in `ConversationFilesPanel`. That panel supersedes the
 * per-turn list which used to duplicate the latest turn's files on screen.
