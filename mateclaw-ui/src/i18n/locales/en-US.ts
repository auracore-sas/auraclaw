export default {
  ...
  chat: {
    ...
    filesPanel: {
      ...
      expand: 'Show the conversation files',
      auxiliaryTitle: 'Intermediate files',
      turnAuxiliary: '+{count} intermediates',
      showAuxiliary: 'Show intermediates ({count})',
      hideAuxiliary: 'Hide intermediates',
      versions: '{count} versions',
      unavailable: 'unavailable',
      unavailableHint: 'No longer available on the server; ask the assistant to produce it again',
      unavailableTitle: 'Files the server no longer has',
      hideUnavailable: 'Hide unavailable ({count})',
      showUnavailable: 'Show unavailable ({count})',
      reason: {
        cited: 'Cited in the final answer',
        deliveryTool: 'Produced by a delivery tool',
        deliveryToolNamed: 'Produced by {tool}',
        documentExt: 'Generated document',
        fallback: 'Turn with no identifiable deliverable',
        auxiliary: 'Intermediate file of the process',
      },
    },
    detail: {
  ...
  settings: {
    ...
    model: {
      ...
      usage: {
        ...
        chat: 'Chat',
        wiki: 'Wiki',
        hint: 'Chat: usable in conversations (default). Uncheck Chat to dedicate the model to internal jobs (e.g. Wiki digestion) — normal chat will never use it, but Wiki can still select it.',
        updated: 'Usage updated',
        updateFailed: 'Failed to update usage',
      },
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. AuraClaw does not modify Claude Code\'s on-disk credentials.',
    ...
    localTools: {
      desktopOnly: 'Local tools are only available inside the desktop client. Open this page in the AuraClaw desktop app to manage them.',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as AuraClaw .env DASHSCOPE_API_KEY',
  ...
  login: {
    ...
    heroDesc: 'AuraClaw is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  onboarding: {
    ...
    send: 'Send',
    startUsing: 'Start Using AuraClaw',
    skip: 'Skip',
    back: 'Back',
  },
  talk: {
  ...
  toolLabels: {
    ...
    readAuraClawDoc: 'Read System Docs',
