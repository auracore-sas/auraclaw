...
KEY (id)
VALUES (1000000001, 'Asistente General', 'Asistente polivalente para preguntas diarias, análisis de datos y llamadas a herramientas', 'react',
        'Eres el Asistente General de AuraClaw. Puedes ayudar a los usuarios a responder preguntas, analizar datos y llamar herramientas para completar tareas. Responde siempre en español, de forma profesional y amable.',
        NULL, 100, TRUE, 'pi:robot-face-happy', 'default,assistant', NOW(), NOW(), 0);

-- Default digital employee: Task Planner (Plan-Execute mode)
MERGE INTO mate_agent (id, name, description, agent_type, system_prompt, model_name, max_iterations, enabled, icon, tags, create_time, update_time, deleted)
KEY (id)
VALUES (1000000002, 'Planificador de Tareas', 'Descompone objetivos complejos en pasos ejecutables y los impulsa hasta completarlos', 'plan_execute',
        'Eres un Planificador de Tareas profesional. Te destacas en descomponer objetivos complejos en pasos ejecutables y completarlos sistemáticamente. Responde siempre en español.',
...
MERGE INTO mate_agent (id, name, description, agent_type, system_prompt, model_name, max_iterations, enabled, icon, tags, create_time, update_time, deleted)
KEY (id)
VALUES (1000000003, 'Analista de Razonamiento', 'Piensa paso a paso con razonamiento visible, ideal para problemas que requieren un análisis minucioso', 'react',
        'Eres un Analista de Razonamiento, un asistente experto en razonamiento profundo. Ante un problema, primero piénsalo paso a paso con un rastro de razonamiento claro, luego llama herramientas o da la respuesta. Responde siempre en español, de forma profesional y amable.',
...
MERGE INTO mate_tool (id, name, display_name, description, tool_type, bean_name, icon, enabled, builtin, create_time, update_time, deleted)
KEY (id)
VALUES (1000000018, 'CronJobTool', 'Tareas Programadas', 'Crea, lista, habilita/deshabilita y elimina tareas programadas (cron jobs) mediante chat. Soporta expresiones cron de 5 campos para programación flexible.', 'builtin', 'cronJobTool', '⏰', TRUE, TRUE, NOW(), NOW(), 0);
...
MERGE INTO mate_tool (id, name, display_name, description, tool_type, bean_name, icon, enabled, builtin, create_time, update_time, deleted)
KEY (id)
VALUES (1000000023, 'CodeExecuteTool', 'Ejecución de Código', 'Ejecuta un fragmento de código (python, bash o node) que el agente escribe sobre la marcha. Permite actuar sobre una habilidad solo-documentación ejecutando el código que describen sus instrucciones. Las operaciones peligrosas requieren aprobación.', 'builtin', 'codeExecuteTool', '🧑‍💻', TRUE, TRUE, NOW(), NOW(), 0);
...
MERGE INTO mate_skill (id, name, description, skill_type, icon, version, author, config_json, enabled, builtin, tags, create_time, update_time, deleted)
KEY (id)
VALUES (1000000002, 'file_reader', 'Lee y resume archivos de texto como txt, md, json, csv, log y código. Los PDF y archivos de Office los manejan habilidades dedicadas.', 'builtin', '📄', '1.0.0', 'MateClaw', '{"upstream":"mateclaw","entryFile":"SKILL.md"}', TRUE, TRUE, 'file,reader,text,summary', NOW(), NOW(), 0);
...
KEY (id)
VALUES (1000000001, 'Consola Web', 'web', 1000000001, '', '{}', TRUE,
